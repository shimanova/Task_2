import allure
import pytest
from api_client import create_order_api
...
class TestCreateOrder:
    ...
    def test_create_order_with_auth(self, create_and_delete_user):
        ...
        response = create_order_api(TestData.VALID_INGREDIENTS, access_token)
    ...
    def test_create_order_without_auth(self):
        response = create_order_api(TestData.VALID_INGREDIENTS)
    ...
    def test_create_order_no_ingredients(self, create_and_delete_user):
        _, _, _, access_token = create_and_delete_user
        response = create_order_api([], access_token)
    ...
    def test_create_order_invalid_hash(self, create_and_delete_user):
        _, _, _, access_token = create_and_delete_user
        response = create_order_api([TestData.INVALID_HASH], access_token)
